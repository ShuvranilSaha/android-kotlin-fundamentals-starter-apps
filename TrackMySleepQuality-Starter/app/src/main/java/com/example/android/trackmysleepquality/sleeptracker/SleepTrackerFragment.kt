...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        sleepTrackerModel.navigateToSleepQuality.observe(viewLifecycleOwner, Observer { it ->
            it?.let {
        ...
        sleepTrackerModel.showSnackBarEvent.observe(viewLifecycleOwner, Observer {
            if (it == true) {
                Snackbar.make(
                ...
                sleepTrackerModel.downShowingSnackBar()
            }
        })
